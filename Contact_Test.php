...
<html lang="en">
  ...
  ?> 
            ...
            <div class="container">
            	<img src="panel4_banner1.png" class="center-block img-responsive" alt="contact_banner">
            </div>
...
<form class="form-horizontal form_margin" role="form" action="lavanya_process_new.php" method="POST">
  ...
  <div class="panel panel-default">
    ...
    <div class="panel-heading" id="headingOne">
      <h2 class="section_title panel-title">
     Contact Me!
